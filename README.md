...
# :book: WebPack Initializer <a name="about-project"></a>

**WebPack Initializer** is a simple website using webpack for better understanding of webpack
...
```sh
    "git clone https://github.com/shihabrafio/Webpack.git"
```
